// Main program borrowed from DynamicMenus.ZIP File
...
namespace PE_Inheritance_JRB
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            MenuItem drawSquare = new DrawSquareItem("Draw", "Draw a square", "What size square would you like drawn?");
            ...
            while (choice != "QUIT")
            {
                ...
                else if(choice == drawSquare.Keyword)
                {
                    drawSquare.Run();
                }
                else if (choice != "QUIT")
