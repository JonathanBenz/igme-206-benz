...
namespace HW6_CritterFarm
{
    ...
    public class Program
    {
        ...
        static void TestCritters()
        {
            ...
            Penguin p1 = new Penguin("Le Manchot");
            Penguin p2 = new Penguin("To Penguinos", 12, 13);

            // Bunny initialization
            Bunny b1 = new Bunny("Rabbina");
            Bunny b2 = new Bunny("Big Chungus", 8, 9);

            // Horse initialization
            Horse h1 = new Horse("to alogo");
            Horse h2 = new Horse("le cheval", 6, 4);
            ...
            foreach(Critter c in list)
            {
                ...
                // Special bunny method
                if(c is Bunny)
                {
                    Bunny b = (Bunny)c;
                    Random rng = new Random();
                    b.EatAllYourMomsFlowers(rng, 100);
                }
