...
namespace HW6_CritterFarm
{
    ...
    /// 
    /// This is the parent class for all Critter Types. 
    /// This class is responsible for handling what happens when you feed, play with, and talk to the critter, 
    /// as well as holding data for FoodAmount, FunAmount, GenAngryLvl, and GenFrustrationLvl. 
    /// All child classes must inherit from the base constructor and require at least a name, type, hungerLevel and boredomLevel. 
    /// All child classes are also responsible for implementing how the critter's mood gets updated. 
    /// 
    /// </summary>
    abstract class Critter
    {
        ...
        ///         
        /// Having this abstract method here in the parent class is a good idea because it makes it mandatory for all child classes to implement this method. 
        /// Depending on the child class, the implementation of how the critter's mood is updated might be different depending on the critter type and other different parameters,
        /// so having it abstract in the parent is a good idea while the specifics are dealt with in the child class. 
        /// 
        /// </summary>
